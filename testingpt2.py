...
can access your bank account, where it will be kept safe from robbers. YOU HAVE 21 DAYS TO HAVE $1,000
IN YOUR BANK ACCOUNT!
--------------------------------------------------------------------------------------------------
        """)
game_beginning = input(f"""You are on Day {player.day_number}. You have {player.hours} hours left. You are at {player.current_loc}.
Where would you like to go?
    Diner (d)
    Bank (b)
    Career Services (c)
...
while player.day_number <= 21:
   # DINER
    while player.current_loc == 'the Diner':
        if player.hours <= 0:
            reset_day()
        elif player.current_loc == 'the Diner':
...
--------------------------------------------------------------------------------------------------
    ...
    while player.current_loc == 'the Bank':
        if player.hours <= 0:
            reset_day()
        elif player.current_loc == 'the Bank':
...
--------------------------------------------------------------------------------------------------
    ...
    while player.current_loc == 'Career Services':
        if player.hours <= 0:
            reset_day()
        elif player.current_loc == 'Career Services':
            a = input(f"""You have {player.hours} hours left. You are at {player.current_loc}. What would you like to do?
    Travel (t)
    View Jobs (v)
    See Stats (s)
...
--------------------------------------------------------------------------------------------------
    ...
    while player.current_loc == 'the Education Center':
        if player.hours <= 0:
            reset_day()
        elif player.current_loc == 'the Education Center':
            a = input(f"""You have {player.hours} hours left. You are at {player.current_loc}. What would you like to do?
    Travel (t)
    Learn (l)
    Work (wo)
...
--------------------------------------------------------------------------------------------------
    ...
    while player.current_loc == 'the Shopping Mall':
        if player.hours <= 0:
            reset_day()
        elif player.current_loc == 'the Shopping Mall':
            a = input(f"""You have {player.hours} hours left. You are at {player.current_loc}. What would you like to do?
    Travel (t)
    Go Shopping (g)
